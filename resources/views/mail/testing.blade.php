	...
	<body>
		<header>
			...
			<address contenteditable>
				{{-- <p>{{$order->name}}</p> --}}
				<p>{{$order->name}}<br>{{$order->address}}, {{$order->state}} {{$order->pincode}}</p>
				<p>{{$order->phone}}</p>
			</address>
			<span> <a href="https://eprashast.co.in/"><img alt="" src="{{asset('backend/img/unnamed (1).png')}}"><input type="file" accept="image/*"></a> </span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address contenteditable>
                  
				<p>ePrashast innovation<br>Private Limited</p>
			</address>
			<table class="meta">
				<tr>
			...
			<table class="inventory">
				...
				<tbody>
					...
					<tr>
						...
						<td><span contenteditable>{{ $order_details[$i]->pqty }}</span></td>
						<td><span data-prefix></span><span contenteditable>₹{{ $order_details[$i]->pprice }}</span></td>
						<td><span data-prefix></span><span contenteditable>₹{{ $order_details[$i]->pqty * $order_details[$i]->pprice }}</span></td>
					</tr>
