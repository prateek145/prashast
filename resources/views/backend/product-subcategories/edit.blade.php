            ...
            <div class="card-body">
                ...
                <form action="{{ route('product-subcategories.update', $productcategories->id) }}" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="status" id="status1" class="form-control" required>
                                    ...
                                    <option value="1" {{ $productcategories->status == 1 ? 'selected' : '' }}>Active
                                    </option>
                                    <option value="0" {{ $productcategories->status == 0 ? 'selected' : '' }}>Inactive
                                    </option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="control-label font-weight-bold">Top Seller</label>
                                <select name="top_seller" id="" class="form-control">
                                    <option value="">Select</option>
                                    @foreach ($productcategories->subproducts($productcategories->id) as $item)
                                        <option value="{{ $item->id }}"
                                            {{ $productcategories->top_seller == $item->id ? 'selected' : '' }}>
                                            {{ $item->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                @if ($productcategories->featured_image != null)
                                    <img src="{{ asset('public/productsubcategory/' . $productcategories->featured_image) }}"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                @if ($productcategories->icon_image != null)
                                    <img src="{{ asset('public/productsubcategory/' . $productcategories->icon_image) }}"
                                        alt="" width="90%" height="90%" class="p-5">
                                @else
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                @if ($productcategories->dark_icon != null)
                                    <img src="{{ asset('public/productsubcategory/' . $productcategories->dark_icon) }}"
                                        alt="" width="90%" height="90%" class="p-5">
                                @else
