        ...
        <div class="container pb-5">
            ...
            <div class="row">
                ...
                <div class="col-lg-7  mt-5 mt-lg-auto">
                    ...
                    <img src="{{asset('public/frontend/images/cat-icon-dark.png')}}" class="d-block">
                    <img src="{{asset('public/frontend/images/line_separator_01.png')}}">
                    <h6>New Collection</h6>
                    <button class="btn btn-link wishlist-link" onclick="addtowishlist('{{ $product->id }}', '{{ $product->sku }}', 'productdetail')">Wishlist <i class="bi bi-heart"></i></button>
                    <h1>{{$product->name}}</h1>
                    ...
                    <span class="d-flex w-100 justify-content-end">
                        <a class="btn btn-primary float-end" onclick="addtocart('{{ $product->id }}', '{{ $product->sku }}', 'productdetail')">Add to Cart</a> &nbsp; <a href="#"
                            class="btn btn-secondary float-end" onclick="addtowishlist('{{ $product->id }}', '{{ $product->sku }}', 'productdetail')">Buy Now</a>
                    </span>
