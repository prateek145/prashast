        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 mx-auto text-center mt-5">
                    <form class="form searchform d-flex col-12"><input type="text" class=" border-0 form-control" placeholder="Search"><button class="btn border-0 bg-light"><i class="bi bi-search"></i></button>
                ...
                <div class="card border-0 mb-5">
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            <h6 class="yellow">ORDER #171-10282</h6>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <button type="button" class="btn float-end" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Download Invoice">
